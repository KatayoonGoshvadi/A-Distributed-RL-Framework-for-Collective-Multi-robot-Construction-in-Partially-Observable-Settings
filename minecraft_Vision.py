...
window = Window(width=800, height=600, caption='Pyglet', resizable=True, visible=True)
class MinecraftEnv(gym.Env):
    ...
    # Initialize env
    def __init__(self, num_agents=1, observation_range=1, observation_mode='id_visible', world0=None, FULL_HELP = False, MAP_ID=1, current_screenshots=[]):
        """
        Args:
        ...
        self.current_screenshots = current_screenshots
    ...
    def _observe(self, agent_id):
        ...
        #taking picture from agent's position
        ...
        #removing the agent from the world and placing the camera
        state[px, py, pz] = 0
...
#         return self.current_screenshots
#        return window.take_pics()
    ...
    def _step(self, action_input, window):
        self.fresh = False
        ...
        # Perform observation
        state = self._observe(agent_id, window) # ORIGINAL 5-TENSOR STATE
